...
class ProjectBuilder {
    ...
    */
    ...
    extractRealProjectNameFromProject () {
        const androidProject = new AndroidProject(this.root);
        const packageName = androidProject.getPackageName();
    ...
    prepBuildFiles () {
        ...
        const projectName = this.extractRealProjectNameFromProject();
